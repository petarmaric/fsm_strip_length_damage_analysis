...
setup(
    ...
    version='1.0.0',
    url='https://bitbucket.org/petar/fsm_strip_length_damage_analysis',
    license='BSD',
    author='Petar Maric',
    ...
    platforms='any',
    py_modules=['fsm_strip_length_damage_analysis'],
    entry_points={
        'console_scripts': ['fsm_strip_length_damage_analysis=fsm_strip_length_damage_analysis:main'],
    },
