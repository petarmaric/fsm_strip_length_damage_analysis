...
.. _`please let us know`: https://bitbucket.org/petar/fsm_strip_length_damage_analysis/issues/new
.. _`the repository`: http://bitbucket.org/petar/fsm_strip_length_damage_analysis
.. _`AUTHORS`: https://bitbucket.org/petar/fsm_strip_length_damage_analysis/src/default/AUTHORS
